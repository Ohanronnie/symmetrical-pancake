      ...
      >
        ...
        <div className="join h-8 mx-2 inline-flex items-center justify-center rounded-md">
          <input
            type="text"
            placeholder="Search"
            className="join-item input border-gray-800 w-[10rem] h-8 bg-[transparent] text-white"
          />
          <button className="border-[1px] inline-flex items-center justify-center rounded-md border-l-0 border-gray-800 border-solid join-item px-1 m-0 h-8 w-8 text-white bg-gray-900">
            ...
            <div className="-my-6 divide-y divide-gray-500/10">
              <div className="space-y-2 py-6">
                <Disclosure as="div" className="-mx-3">
                  {({ open }) => (
                    <>
                      <Disclosure.Button className="flex w-full items-center justify-between rounded-lg py-2 pl-3 pr-3.5 text-base font-semibold leading-7 text-white hover:bg-slate-700">
                        Product
                        <ChevronDownIcon
                      ...
                      <Disclosure.Panel className="mt-2 space-y-2">
                        {[...products, ...callsToAction].map((item) => (
                          <Disclosure.Button
                            ...
                            as="a"
                            href={item.href}
                            className="block rounded-lg py-2 pl-6 pr-3 text-sm font-semibold leading-7 text-white hover:bg-slate-700"
                          >
                            {item.name}
                          </Disclosure.Button>
                        ))}
